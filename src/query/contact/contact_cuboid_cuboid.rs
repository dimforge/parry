...
use crate::query::{sat, Contact, PointQuery, QueryOptionsNotUsed};
...
pub fn contact_cuboid_cuboid(
    ...
    if sep1.0 >= sep2.0 && sep1.0 >= sep3.0 {
        ...
        let proj1 = cuboid1.project_local_point(&pt2_1, false, &QueryOptionsNotUsed);
    ...
    if sep2.0 >= sep1.0 && sep2.0 >= sep3.0 {
        ...
        let proj2 = cuboid2.project_local_point(&pt1_2, false, &QueryOptionsNotUsed);
