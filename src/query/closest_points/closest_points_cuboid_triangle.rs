...
use crate::query::{sat, ClosestPoints, PointQuery, QueryOptionsNotUsed};
...
pub fn closest_points_cuboid_triangle(
    ...
    if sep1.0 >= sep2.0 && sep1.0 >= sep3.0 {
        ...
        let proj1 = cuboid1.project_local_point(&pt2_1, true, &QueryOptionsNotUsed);
    ...
    if sep2.0 >= sep1.0 && sep2.0 >= sep3.0 {
        ...
        let proj2 = triangle2.project_local_point(&pt1_2, true, &QueryOptionsNotUsed);
