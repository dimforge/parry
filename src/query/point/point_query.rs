...
pub trait PointQuery {
    ...
    fn project_point(&self, m: &Isometry, pt: &Point<Real>, solid: bool) -> PointProjection {
    ...
    #[inline]
    fn distance_to_point(&self, m: &Isometry, pt: &Point<Real>, solid: bool) -> Real {
    ...
    #[inline]
    fn contains_point(&self, m: &Isometry, pt: &Point<Real>) -> bool {
