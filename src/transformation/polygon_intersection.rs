...
mod test {
    ...
    fn intersect_triangle_common_vertex() {
        let tris = [
            (
                Triangle::new(
                    Point2::new(-0.000_875_953_76, -2.010_387_2),
                    Point2::new(0.390_390_87, -1.342_176_4),
                    Point2::new(1.338_081_8, -2.009_800_7),
                ),
                Triangle::new(
                    Point2::new(0.0, -0.0),
                    Point2::new(-0.000_875_953_76, -2.010_387_2),
                    Point2::new(1.999_198, -2.009_511_2),
                ),
            ),
            (
                Triangle::new(
                    Point2::new(0.731_931_57, -0.000_040_469_815),
                    Point2::new(2.000_491_4, -0.000_110_610_774),
                    Point2::new(1.184_840_6, -0.815_571_25),
                ),
                Triangle::new(
                    Point2::new(0.0, 0.0),
                    Point2::new(0.000_110_610_774, -2.000_024_8),
                    Point2::new(2.000_491_4, -0.000_110_610_774),
                ),
            ),
            (
                Triangle::new(
                    Point2::new(-0.000_049_995_168, -0.989_880_14),
                    Point2::new(0.0, -0.0),
                    Point2::new(0.583_013_3, -1.417_013_6),
                ),
                Triangle::new(
                    Point2::new(0.0, -0.0),
                    Point2::new(-0.000_101_013_95, -2.000_027_4),
                    Point2::new(2.000_372_6, 0.000_101_013_95),
                ),
            ),
            (
                Triangle::new(
                    Point2::new(-0.940_565_65, -0.939_805),
                    Point2::new(0.0, -0.0),
                    Point2::new(-0.001_533_592_4, -0.928_358_7),
                ),
                Triangle::new(
                    Point2::new(0.0, -0.0),
                    Point2::new(-2.007_526_4, -2.005_902_8),
                    Point2::new(-0.003_308_165_1, -2.002_594_5),
                ),
            ),
        ];
