...
fn main() {
    ...
    let ball_pos_will_touch = Pose::translation(2.0, 2.0);
    let ball_pos_wont_touch = Pose::translation(3.0, 3.0);

    let box_vel1 = Vector::new(-1.0, 1.0);
    let box_vel2 = Vector::new(1.0, 1.0);
