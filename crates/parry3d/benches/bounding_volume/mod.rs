 ...
 */
bench_method!(bench_cuboid_aabb, aabb: Aabb, c: Cuboid, m: Pose3<f32>);
bench_method!(
...
bench_method!(bench_ball_aabb, aabb: Aabb, b: Ball, m: Pose3<f32>);
bench_method!(
...
bench_method!(bench_cone_aabb, aabb: Aabb, c: Cone, m: Pose3<f32>);
bench_method!(
