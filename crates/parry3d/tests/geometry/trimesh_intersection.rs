...
fn trimesh_plane_edge_intersection() {
    ...
    let result = mesh.intersection_with_local_plane(&Vector3::ith_axis(2), 0.5, f32::EPSILON);
...
fn trimesh_plane_vertex_intersection() {
    ...
    let result = mesh.intersection_with_local_plane(&Vector3::ith_axis(2), 0.0, f32::EPSILON);
...
fn trimesh_plane_mixed_intersection() {
    ...
    let result = mesh.intersection_with_local_plane(&Vector3::ith_axis(0), 0.0, f32::EPSILON);
...
fn trimesh_plane_above() {
    ...
    let result = mesh.intersection_with_local_plane(&Vector3::ith_axis(2), -5.0, f32::EPSILON);
